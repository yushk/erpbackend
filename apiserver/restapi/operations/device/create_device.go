...
type CreateDeviceHandlerFunc func(CreateDeviceParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn CreateDeviceHandlerFunc) Handle(params CreateDeviceParams, principal interface{}) middleware.Responder {
	return fn(params, principal)
}

// CreateDeviceHandler interface for that can handle valid create device params
type CreateDeviceHandler interface {
	Handle(CreateDeviceParams, interface{}) middleware.Responder
}
