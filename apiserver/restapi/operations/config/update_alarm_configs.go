...
type UpdateAlarmConfigsHandlerFunc func(UpdateAlarmConfigsParams, *v1.Principal) middleware.Responder

// Handle executing the request and returning a response
func (fn UpdateAlarmConfigsHandlerFunc) Handle(params UpdateAlarmConfigsParams, principal *v1.Principal) middleware.Responder {
...
type UpdateAlarmConfigsHandler interface {
	Handle(UpdateAlarmConfigsParams, *v1.Principal) middleware.Responder
}
