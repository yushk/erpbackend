...
type VersionOK struct {
	...
	/*
	  In: Body
	*/
	Payload *VersionOKBody `json:"body,omitempty"`
}
...
func (o *VersionOK) WithPayload(payload *VersionOKBody) *VersionOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the version o k response
func (o *VersionOK) SetPayload(payload *VersionOKBody) {
	o.Payload = payload
}
