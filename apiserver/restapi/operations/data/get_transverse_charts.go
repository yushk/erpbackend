...
func NewGetTransverseCharts(ctx *middleware.Context, handler GetTransverseChartsHandler) *GetTransverseCharts {
	return &GetTransverseCharts{Context: ctx, Handler: handler}
}

/*GetTransverseCharts swagger:route GET /v1/devices/charts/transverse data getTransverseCharts
...
*/
type GetTransverseCharts struct {
	Context *middleware.Context
	Handler GetTransverseChartsHandler
}

func (o *GetTransverseCharts) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	route, rCtx, _ := o.Context.RouteInfo(r)
	if rCtx != nil {
		r = rCtx
	}
	var Params = NewGetTransverseChartsParams()
